...
# Data parameters
tf.flags.DEFINE_string('data_file', 'test.csv', 'Data file path')
...
tf.flags.DEFINE_integer('level', 1, '1 for char level, 2 for phrase level')
...
tf.flags.DEFINE_integer('num_layers', 2, 'Number of the LSTM cells')  # RNN
